...
import { DaffCheckoutShippingContainer } from './shipping.component';
import {
...
describe('DaffCheckoutShippingContainer', () => {
  let component: DaffCheckoutShippingContainer;
  let fixture: ComponentFixture<DaffCheckoutShippingContainer>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ DaffCheckoutShippingContainer ],
      providers:[
        provideMockStore({}),
      ],
    })
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DaffCheckoutShippingContainer);
