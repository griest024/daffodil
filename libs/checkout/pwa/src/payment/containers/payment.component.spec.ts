...
import { DaffCheckoutPaymentContainer } from './payment.component';
...
describe('DaffCheckoutPaymentContainer', () => {
  let component: DaffCheckoutPaymentContainer;
  let fixture: ComponentFixture<DaffCheckoutPaymentContainer>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ DaffCheckoutPaymentContainer ],
      providers: [
        provideMockStore({}),
      ],
    })
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DaffCheckoutPaymentContainer);
