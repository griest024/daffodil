...
import { DemoAddToCartNotificationComponent } from './add-to-cart-notification.component';
import {
...
describe('DemoAddToCartNotificationComponent', () => {
  ...
  let addToCartNotification: DemoAddToCartNotificationComponent;
