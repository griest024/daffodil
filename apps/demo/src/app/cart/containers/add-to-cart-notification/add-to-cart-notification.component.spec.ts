...
import { DemoAddToCartNotificationContainer } from './add-to-cart-notification.component';
import {
...
@Component({ template: '<demo-add-to-cart-notification-container></demo-add-to-cart-notification-container>' })
...
describe('DemoAddToCartNotificationContainer', () => {
  ...
  let addToCartNotification: DemoAddToCartNotificationContainer;
      ...
      imports: [
        StoreModule.forRoot({
          ...
          [DAFF_CART_STORE_FEATURE_KEY]: daffComposeReducers<DaffCartReducersState>([
            combineReducers(daffCartReducersFactory()),
            combineReducers({
  ...
  beforeEach(() => {
    ...
    addToCartNotification = fixture.debugElement.query(By.css('demo-add-to-cart-notification-container')).componentInstance;
  });
